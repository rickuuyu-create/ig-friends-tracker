...
const en = {
  ...
  'avatar.helpIntro': 'For a public account, you can use a profile photo downloader without messaging the person.',
  'avatar.step1Title': 'Copy the username',
  'avatar.step1Body': 'The button below copies the IG username already entered in this form.',
  'avatar.step2Title': 'Download the public photo',
  'avatar.step2Body': 'Paste the username into the downloader, then save the profile picture to your device.',
  ...
  'avatar.openDownloader': 'Copy username & open downloader',
  'avatar.copyAndOpenHint': 'On the next page, paste the username into the search box.',
  'avatar.usernameNeeded': 'Enter an IG username first to use the downloader.',
  'avatar.thirdPartyNote': 'This opens a third-party website for public profiles only. Never enter your Instagram password there.',
  'avatar.privacyNote': 'Only download and keep photos for a legitimate personal use. Third-party availability may change.',
...
const zhTW: Record<TranslationKey, string> = {
  ...
  'avatar.helpIntro': '如果是公開帳號，你可以使用頭像下載網站，不需要特意私訊對方。',
  'avatar.step1Title': '複製用戶名稱', 'avatar.step1Body': '下方按鈕會複製你已在表單輸入的 IG 用戶名稱。',
  'avatar.step2Title': '下載公開頭像', 'avatar.step2Body': '把用戶名稱貼到下載網站，再將頭像儲存到裝置。',
  'avatar.step3Title': '回來上傳', 'avatar.step3Body': '回到表單按「上傳照片」。圖片會先壓縮再儲存。',
  'avatar.copyUsername': '複製用戶名稱', 'avatar.copied': '已複製',
  'avatar.openDownloader': '複製用戶名稱並開啟下載器', 'avatar.copyAndOpenHint': '在下一頁把用戶名稱貼到搜尋欄。',
  'avatar.usernameNeeded': '請先輸入 IG 用戶名稱，才能使用下載器。',
  'avatar.thirdPartyNote': '此功能會開啟只適用於公開帳號的第三方網站。切勿在該網站輸入 Instagram 密碼。',
  'avatar.privacyNote': '只應為合理的個人用途下載及保存照片。第三方網站日後可能會改動或停止服務。',
