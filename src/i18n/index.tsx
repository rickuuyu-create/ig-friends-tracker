...
const en = {
  ...
  'common.open': 'Open',
  'common.done': 'Done',
  'speech.play': 'Play the pronunciation of {name}',
  'speech.stop': 'Stop playing',
  ...
  'form.birthday': 'Birthday (Optional)',
  ...
  'tour.speakTitle': 'Hear how a name is said',
  'tour.speakBody': 'Tap the speaker beside a name to hear it read aloud, so you never have to paste it into a translator. Tap again to stop.',
  ...
  'tour.birthdayTitle': 'Remember a birthday',
  'tour.birthdayBody': 'Optional. Fill it in when you know it and it appears on the friend page.',
...
const zhTW: Record<TranslationKey, string> = {
  ...
  'speech.play': '播放「{name}」的讀音', 'speech.stop': '停止播放',
  'login.title': 'IG Friends Tracker',
  ...
  'form.username': 'IG 用戶名稱', 'form.realName': '真實姓名／備註名稱', 'form.birthday': '生日（選填）',
  ...
  'tour.speakTitle': '聽名字怎樣讀', 'tour.speakBody': '點名字旁邊的喇叭就會讀出名字，不用再複製去翻譯網站。播放中再點一次即可停止。',
  'tour.addTitle': '記錄新認識的朋友', 'tour.addBody': '剛認識新朋友後由這裡開始。接下來會介紹最重要的欄位。',
  'tour.birthdayTitle': '記下生日', 'tour.birthdayBody': '選填。知道對方生日就填上，之後會顯示在該位朋友的詳細頁。',
